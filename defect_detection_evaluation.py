...
def defect_detection(input_name_model,test_size, opt):
    ...
    alpha = int(opt.alpha)
    path =  "fundus_test_scale" + str(scale) + "_" + str(pos_class) + "_" + str(opt.num_images)
    if os.path.exists(path)==True:
        xTest_input = np.load(path + "/fundus_data_test_" + str(pos_class) + str(scale) +  "_" + str(opt.index_download) + ".npy")
        yTest_input = np.load(path + "/fundus_labels_test_" + str(pos_class) + str(scale) +  "_" + str(opt.index_download) + ".npy")
    else:
